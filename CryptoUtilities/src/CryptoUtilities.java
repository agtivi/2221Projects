...
public final class CryptoUtilities {
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
        ...
        NaturalNumber one = new NaturalNumber2(1), two = new NaturalNumber2(2),
                copyN = new NaturalNumber2(n);
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        n.increment();
        NaturalNumber one = new NaturalNumber2(1), two = new NaturalNumber2(2),
                wCopy = new NaturalNumber2(w), wCopy2 = new NaturalNumber2(w),
                nCopy = new NaturalNumber2(n);
    ...
    public static void generateNextLikelyPrime(NaturalNumber n) {
        ...
        isPrime = isPrime2(n);
        while (!isPrime) {
            NaturalNumber compare = new NaturalNumber2(),
                    temp = new NaturalNumber2(n), zero = new NaturalNumber2(0),
                    two = new NaturalNumber2(2);
            compare = temp.divide(two);
